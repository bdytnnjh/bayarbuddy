...
import 'package:app/presentation/screens/register/set_up_name_screen.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleSignUp() async {
    ...
    if (success && mounted) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => const SetUpNameScreen()));
