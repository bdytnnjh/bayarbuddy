...
import 'package:app/data/repositories/trusred_contect_repository.dart';
...
class TrustedContactProvider with ChangeNotifier {
  ...
  // Load all trusted contacts for current user
  ...
  // Delete trusted contact (soft delete)
  ...
  // Permanently delete trusted contact
