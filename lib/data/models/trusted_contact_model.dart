...
class TrustedContactModel {
  ...
  // Convert TrustedContactModel to Map for Firestore
  ...
  // Create TrustedContactModel from Firestore document
  ...
  // Create TrustedContactModel from DocumentSnapshot
  factory TrustedContactModel.fromSnapshot(DocumentSnapshot<Map<String, dynamic>> doc) {
    final data = doc.data();
    if (data == null) {
